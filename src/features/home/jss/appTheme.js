  ...
  createTheme({
    palette: {
      ...
      text: {
        ...
        secondary: isNightMode ? '#6f6e84' : '#00000066',
      },
    },
    overrides: {
      MuiButton: {
